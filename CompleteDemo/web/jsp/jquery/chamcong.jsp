        ...
        <div id="ja-wrapper-inner" class="clearfix">		
            ...
            <div id="dialog_search" title="Tìm kiếm" >
                <table width="70%">
                    ...
                    <tr> 
                        <td align=right><label for="trangthai_search">Trạng thái</label></td>
                        <td align=left><input type="text" id="trangthai_search" name="trangthai_search" value="" class="text ui-widget-content ui-corner-all" maxlength="" /></td>
                    </tr>
                    <tr>
                        <td></td>
...
<script type="text/javascript">
    ...
    function reloadchamcongList()
    {
        ...
        params += "&trangthai=" + $("#trangthai_search").val();
    ...
    function isValidForm_create() {
        ...
        var trangthai = trim($("#trangthai_create").val());
        if (!((machamcong == "") || (manv == "") || (ngaychamcong == "") || (trangthai == ""))) {
            return true;
        }
    }
    ...
    function isValidForm_edit() {
        ...
        var trangthai = trim($("#trangthai_edit").val());
        if (!((machamcong == "") || (manv == "") || (ngaychamcong == "") || (trangthai == ""))) {
            return true;
        }
    }
    ...
    $(function () {
        ...
        jQuery("#chamcongGrid").jqGrid({
            ...
            datatype: "xml",
            colNames: ['STT', 'Mã chấm công', 'Mã nhân viên', 'Ngày chấm công', 'Trạng thái'],
            colModel: [
                {name: 'STT', index: 'STT', width: 80, align: "center"},
                {name: 'machamcong', index: 'machamcong', width: 100},
                {name: 'manv', index: 'manv', width: 200},
                {name: 'ngaychamcong', index: 'ngaychamcong', width: 200},
                {name: 'trangthai', index: 'trangthai', width: 100, align: "right"}
            ],
            ...
            width: 900,
            shrinkToFit: false,
            caption: " Danh sách chấm công",
            sortname: 'manv', viewrecords: true, sortorder: "asc"
                                ...
                                click: function () {
                                    ...
                                    if (isValidForm_create())
                                    {
                                        $.ajax({
                                            type: "POST",
                                            url: "<%=request.getContextPath()%>/chamcong_Servlet",
                                            data: {"xml": "<doc><method>create</method><machamcong>" + $("#machamcong_create").val() + "</machamcong><manv>" + $("#manv_create").val() + "</manv><ngaychamcong>" + $("#ngaychamcong_create").val() + "</ngaychamcong><trangthai>" + $("#trangthai_create").val() + "</trangthai></doc>"},
                                            error: function () {
                                                $("#dialog_error").dialog({
                                                    modal: true,
                                                    buttons: {
        ...
        $("#edit")
                ...
                .click(function () {
                                ...
                                click: function () {
                                    ...
                                    if (isValidForm_edit())
                                    {
                                        $.ajax({
                                            type: "POST",
                                            url: "<%=request.getContextPath()%>/chamcong_Servlet",
                                            data: {"xml": "<doc><method>update</method><machamcong>" + $("#machamcong_edit").val() + "</machamcong><manv>" + $("#manv_edit").val() + "</manv><ngaychamcong>" + $("#ngaychamcong_edit").val() + "</ngaychamcong><trangthai>" + $("#trangthai_edit").val() + "</trangthai></doc>"},
                                            error: function () {
                    ...
                    if (id) {
                        ...
                        $("#trangthai_edit").val(ret.trangthai);
                            ...
                            buttons: {
                                "Xóa": function () {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "<%=request.getContextPath()%>/chamcong_Servlet",
                                        data: {"xml": "<doc><method>delete</method><machamcong>" + ret.machamcong + "</machamcong><manv>" + $("#manv_edit").val() + "</manv><ngaychamcong>" + $("#ngaychamcong_edit").val() + "</ngaychamcong><trangthai>" + $("#trangthai_edit").val() + "</trangthai></doc>"},
                                        error: function () {
                                            $("#dialog_error").dialog({
                                                modal: true,
                                                buttons: {
    ...
    <form>
        <table width="100%">
            ...
            <tr>
                ...
                <td align=left><input type="text" id="ngaychamcong_create" name="ngaychamcong_create" value="" class="text ui-widget-content ui-corner-all" maxlength="18" /></td>
            </tr>
            <tr>
                <td align=left><label for="trangthai_create">Trạng thái<font color="red"> (*)</font></label></td>
                <td align=left><input type="text" id="trangthai_create" name="trangthai_create" value="" class="text ui-widget-content ui-corner-all" maxlength="255" /></td>
            </tr>
            <tr></tr>
        </table>
    </form>
    ...
    <form>
        <table width="100%">
            ...
            <tr>
                ...
                <td align=left><input type="text" id="ngaychamcong_edit" name="ngaychamcong_edit" value="" class="text ui-widget-content ui-corner-all" maxlength="18" /></td>
            </tr>
             <tr>
                <td align=left><label for="trangthai_edit">Trạng thái<font color="red"> (*)</font></label></td>
                <td align=left><input type="text" id="trangthai_edit" name="trangthai_edit" value="" class="text ui-widget-content ui-corner-all" maxlength="255" /></td>
            </tr>
            <tr>
            </tr>
        </table>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#trangthai_search").keypress(function (event) {
            if (event.which == 13) {
                reloadchamcongList();
            }
        });
